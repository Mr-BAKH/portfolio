...
const App = ()=>{
    ...
    return(
        ...
        <div className="flex bg-slate-800 items-start flex-wrap w-full p-[10vh] sm:p-[10px] relative">
          ...
          <div className="w-full relative flex flex-wrap items-center justify-evenly">
            <p className='text-foote-top text-center tracking-wide w-full p- sm:w-3/6 text-initial text-slate-100 drop-shadow-lg '>
